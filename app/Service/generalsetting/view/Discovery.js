Ext.define('DESKTOP.Service.generalsetting.view.Discovery', {
    extend: 'Ext.form.Panel',
    alias: 'widget.discovery',
    requires: [
        //'DESKTOP.SystemSetup.generalsetting.view.DiscoveryController',
        //'DESKTOP.SystemSetup.generalsetting.view.DiscoveryModel',
        'Ext.slider.*'
    ],
	/*
