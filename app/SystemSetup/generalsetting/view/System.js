Ext.define('DESKTOP.SystemSetup.generalsetting.view.System', {
    /* Design UI layout*/
    extend: 'Ext.form.Panel',
    alias: 'widget.system',
    requires: [
        'DESKTOP.SystemSetup.generalsetting.controller.SystemController',
        'DESKTOP.SystemSetup.generalsetting.model.SystemModel'
    ],
    controller: 'system',
    viewModel: {
        type: 'system'
