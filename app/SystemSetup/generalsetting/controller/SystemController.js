Ext.define('DESKTOP.SystemSetup.generalsetting.controller.SystemController', {
    ...
    onChangePassword: function () {
        var me = this,
            meView = me.getView(),
            appwindow = meView.up('#appwindow');
        var chande_password = Ext.create('DESKTOP.SystemSetup.generalsetting.view.SystemPassword', {
            parentWindowId: appwindow.id,
            parentMask: true
        });
        Ext.apply(appwindow, {
            childWindowId: chande_password.id
        });
